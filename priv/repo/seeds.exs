  ...
  {:ok, _} ->
    robin =
      Poison.encode!(%Bird{
        ...
        attribution:
          "\"Erithacus rubecula with cocked head\" by © Francis C. Franklin / CC-BY-SA-3.0. Licensed under CC BY-SA 3.0 via Commons",
        attribution_link:
          "https://commons.wikimedia.org/wiki/File:Erithacus_rubecula_with_cocked_head.jpg"
      })
    ...
    mockingbird =
      Poison.encode!(%Bird{
        ...
        attribution_link:
          "https://commons.wikimedia.org/wiki/File:Mimus_polyglottos_adult_02_cropped.jpg"
      })
    ...
    nuthatch =
      Poison.encode!(%Bird{
        ...
        attribution:
          "\"Sitta europaea -Kent, England-8\" by Smudge 9000 - Flickr: Nuthatch (Sitta europaea). Licensed under CC BY-SA 2.0 via Commons",
        attribution_link:
          "https://commons.wikimedia.org/wiki/File:Sitta_europaea_-Kent,_England-8.jpg"
      })
    ...
    bluetit =
      Poison.encode!(%Bird{
        ...
        attribution:
          "\"Parus caeruleus01\". Lizenziert unter CC BY-SA 3.0 über Wikimedia Commons",
    ...
    woodpecker =
      Poison.encode!(%Bird{
        ...
        attribution:
          "\"FlyingDendrocoposMajor\" von David Meisel (BlueFox at de.wikipedia) - own photography, first upload on de.wikipedia.org (de:Bild:FlyingDendrocoposMajor.jpg). Lizenziert unter CC BY-SA 2.0 de über Wikimedia Commons",
    ...
    kingfisher =
      Poison.encode!(%Bird{
        ...
        attribution:
          "\"Ein Eisvogel im Schwebflug\" von Joefrei - Eigenes Werk. Lizenziert unter CC BY-SA 3.0 über Wikimedia Commons",
    ...
    jay =
      Poison.encode!(%Bird{
        ...
        date: "2008",
        attribution:
          "\"Garrulus glandarius B Luc Viatour\" von I, Luc Viatour. Lizenziert unter CC BY-SA 3.0 über Wikimedia Commons",
        attribution_link:
          "https://commons.wikimedia.org/wiki/File:Garrulus_glandarius_B_Luc_Viatour.jpg"
      })
    ...
    blackbird =
      Poison.encode!(%Bird{
        ...
        date: "30 May 2007",
        attribution:
          "\"Blackbird 2\" by w:User:SonNy cZ - Originally uploaded to wikipedia by w:User:SonNy cZ on 30 May 2007. Licensed under CC BY-SA 3.0 via Commons",
